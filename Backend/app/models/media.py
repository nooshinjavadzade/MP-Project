...
from sqlalchemy import DateTime, Enum as SQLEnum, Float, Integer, String, Text, func, UniqueConstraint
...
class Media(Base):
    ...
    __table_args__ = (
        UniqueConstraint("tmdb_id", "media_type", name="uq_media_tmdb_type"),
    )

    id: Mapped[int] = mapped_column(primary_key=True, index=True)
    tmdb_id: Mapped[str] = mapped_column(String(20), nullable=False, index=True)
    ...
    community_ratings_count: Mapped[int | None] = mapped_column(Integer, nullable=True)
